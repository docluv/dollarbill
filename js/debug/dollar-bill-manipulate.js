...
(function (window, undefined) {
    ...
    dollarbill.fn.before = function (content) { };

    dollarbill.fn.clone = function (withDataAndEvents ) { };

    dollarbill.fn.detach = function () { };

    dollarbill.fn.empty = function () { };

    dollarbill.fn.insertAfter = function () { };

    dollarbill.fn.insertBefore = function () { };
    ...
    dollarbill.fn.replaceAll = function () { };

    dollarbill.fn.replaceWith = function () { };
